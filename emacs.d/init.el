...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (haskell-mode yaml-mode ssh-file-modes smex paredit markdown-mode magit ido-ubiquitous go-mode closure-lint-mode clojurescript-mode cider better-defaults))))
(custom-set-faces
